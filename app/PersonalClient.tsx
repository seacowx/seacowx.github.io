...
import type { DetectedProject } from '@/lib/getProjects'
...
type SectionId = 'home' | 'education' | 'work' | 'publications' | 'projects' | 'contact'
...
export function PersonalClient({ projects }: Props) {
